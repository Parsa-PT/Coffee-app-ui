import { Text, View , Image , TextInput , FlatList , TouchableOpacity , Dimensions} from "react-native";
    ...
    <View style={{
      ...
      <View style={{ 
        ...
        <View style={{paddingHorizontal:20 , marginTop:62 , position:'relative'}}>
          ...
          <TouchableOpacity onPress={()=> route.push('(tabs)')}  style={{width:40 , height:40 , borderRadius:40 , backgroundColor:'#A67B5B' , display:'flex',
            justifyContent: 'center',
